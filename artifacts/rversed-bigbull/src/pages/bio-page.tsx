...
export function BioPage() {
  ...
  return <div className="route-in">{/* Back navigation for mobile users */}
      <BackButton />
      <PageHeading eyebrow="Featured partner / profile utility" title="Bio Tool." detail="A direct launch surface for the free Bio Tool. Check its live channel before you go." action={<StatusPill status={tool.status} />} />
